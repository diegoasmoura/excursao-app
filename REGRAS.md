...
Versão: o número em `package.json` sobe **em todo commit**. No computador a tela mostra `V1.1.5` (hoje). No celular não aparece. Correção = último número; função nova = do meio; mudança grande = o primeiro.
